...
[assembly: PreApplicationStartMethod(typeof(ZSharp.Framework.Mvc.Plugins.PluginManager), "Initialize")]
    ...
    public class PluginManager
    {
        ...
        public static void Initialize()
        {
			...
			using (Locker.GetWriteLock())
            {
                ...
                _clearShadowDirectoryOnStartup = CommonConfig.ClearPluginsShadowDirectoryOnStartup;
                try
                {	
        ...
        {
            GuardHelper.ArgumentNotNull(() => descriptor);
