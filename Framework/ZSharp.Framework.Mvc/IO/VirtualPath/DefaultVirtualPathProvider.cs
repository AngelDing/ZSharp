    ...
    public class DefaultVirtualPathProvider : IVirtualPathProvider
    {
        ...
        public virtual string ToAppRelative(string virtualPath)
        {
            ...
            catch (Exception e)
            {
                ...
                _logger.Info("Path '{0}' cannot be made app relative".FormatCurrent(virtualPath), e);
                return null;
            }
        }
        ...
        public virtual bool TryFileExists(string virtualPath)
        {
            ...
            {
                _logger.Info("File '{0}' can not be checked for existence. Assuming doesn't exist.".FormatCurrent(virtualPath), e);
                return false;
            }
        }
