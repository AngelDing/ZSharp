...
namespace ZSharp.Framework.WebApi.OutputCache
{
    public class CacheOutputConfiguration
    {
        ...
        public IApiOutputCache GetCacheOutputProvider(HttpRequestMessage request)
        {
            ...
            var cacheOutputProvider = cacheFunc != null ? cacheFunc() : request.GetDependencyScope().GetService(typeof(IApiOutputCache)) as IApiOutputCache ?? new DefaultMemoryCache();
