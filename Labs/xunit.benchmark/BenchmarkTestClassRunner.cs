...
namespace Microsoft.Xunit
{
    class BenchmarkTestClassRunner : TestClassRunner<BenchmarkTestCase>
    {
        ...
        {
            return new BenchmarkTestMethodRunner(testMethod, Class, method, testCases, MessageBus, new ExceptionAggregator(Aggregator), CancellationTokenSource, DiagnosticMessageSink).RunAsync();
        }
    }
}
