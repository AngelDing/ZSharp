...
namespace Framework.WebApi.OutputCache.Tests
{
    class CacheKeyGeneratorTests
    {
        ...
        public void custom_default_cache_key_generator_called_and_key_used()
        {
            ...
            _cache.Verify(s => s.Add(It.Is<string>(x => x == "keykeykey"), It.IsAny<byte[]>(), It.Is<DateTimeOffset>(x => x <= DateTime.Now.AddSeconds(100)), It.Is<string>(x => x == "framework.webapi.outputcache.tests.samplecontroller-get_c100_s100")), Times.Once());
            _cache.Verify(s => s.Add(It.Is<string>(x => x == "keykeykey:response-ct"), It.IsAny<object>(), It.Is<DateTimeOffset>(x => x <= DateTime.Now.AddSeconds(100)), It.Is<string>(x => x == "framework.webapi.outputcache.tests.samplecontroller-get_c100_s100")), Times.Once());
        ...
        public void custom_cache_key_generator_called()
        {
            ...
            _cache.Verify(s => s.Add(It.Is<string>(x => x == "custom_key"), It.IsAny<byte[]>(), It.Is<DateTimeOffset>(x => x <= DateTime.Now.AddSeconds(100)), It.Is<string>(x => x == "framework.webapi.outputcache.tests.cachekeycontroller-get_custom_key")), Times.Once());
            _cache.Verify(s => s.Add(It.Is<string>(x => x == "custom_key:response-ct"), It.IsAny<object>(), It.Is<DateTimeOffset>(x => x <= DateTime.Now.AddSeconds(100)), It.Is<string>(x => x == "framework.webapi.outputcache.tests.cachekeycontroller-get_custom_key")), Times.Once());
        }
    }
}
