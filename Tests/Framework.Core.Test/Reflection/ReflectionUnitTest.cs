...
namespace Framework.Reflection.Test
{
    public class ReflectionUnitTest
    {
        ...
        {
            dynamicFooType = typeof(MarkerType).Assembly.GetDynamicType("Framework.Core.Test.Foo");
            dynamicFoo = typeof(MarkerType).Assembly.CreateDynamicInstance("Framework.Core.Test.Foo");
        }
        ...
        {
            Assert.Throws<ArgumentException>(delegate { dynamicFoo.NotExist = "Hello"; });            
        }
        ...
        public void TestMethodCallThatTakesType()
        {
            ...
            Assert.Equal("Framework.Core.Test.Foo", typeName);
        }
